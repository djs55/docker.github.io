...
- Filesharing
  ...
  - Fixed a bug which prevented open files from being deleted, [docker/for-win#5565](https://github.com/docker/for-win/issues/5565).
  ...
  - Docker Desktop now displays hidden files on shared volumes, [docker/for-win#5808](https://github.com/docker/for-win/issues/5808).
  ...
  - Fixed a bug where files did not change in shared volumes when using `volumes_from` in docker-compose.yml, see [docker/for-win#5530](https://github.com/docker/for-win/issues/5530)
...
- Docker Desktop now uses the least possible privilege for querying the LanManServer service. Fixes [docker/for-win#5150](https://github.com/docker/for-win/issues/5150).
